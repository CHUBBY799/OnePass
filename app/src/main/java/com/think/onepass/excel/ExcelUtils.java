package com.think.onepass.excel;
...
public class ExcelUtils {
	...
	public static void initExcel(String fileName, String[] colName) {
		...
		try {
			...
			WritableSheet sheet = workbook.createSheet("passport", 0);
			//创建标题栏
...
//				sheet.mergeCells()
				...
				writebook.write();
				Toast.makeText(c, R.string.data_excel_success, Toast.LENGTH_SHORT).show();
			} catch (Exception e) {
				e.printStackTrace();
			} finally {
				if (writebook != null) {
